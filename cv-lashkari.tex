...
\newcommand{\WorkExperience}[9]{
    ...
    \quad#2&%
        \ifthenelse{\equal{#4}{Lecturer}}
            {%
                \scriptsize\textit{Responsibility:} #4\\
                \quad#3&\scriptsize\textit{Courses Taught:} #5}
            {}%
        \ifthenelse{\equal{#4}{Open Source}}
            {%
                #4\\
                \quad#3
                &\scriptsize\textit{Implemented by:} #5. \scriptsize\textit{Source:} #6\\
                &\scriptsize\textit{Implemented by:} #7. \scriptsize\textit{Source:} #8}
            {}%
        \ifthenelse{\equal{#4}{Programmer}}
            {%
                ...
                &\scriptsize\textit{Project:} #6\\
                &\scriptsize\textit{Project:} #7
            }
            {}%
        \ifthenelse{\equal{#4}{Senior Android Developer}}
            {%
                \scriptsize\textit{Responsibility:} #4\\
                \quad#3
                &\scriptsize\textit{Project:} #5\\
                &       \quad\quad #6\\
                &       \quad\quad #7\\
                &\scriptsize\textit{Project:} #8\\
                &       \quad\quad #9
            }
            {}%
...
\newcommand{\WorkExperienceHasinOne}[5]{
                &\scriptsize\textit{Project:} #1\\
                &       \quad\quad #2\\
                &\scriptsize\textit{Project:} #3\\
                &       \quad\quad #4\\
                &\scriptsize\textit{Project:} #5\\
}
